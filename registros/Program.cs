namespace AulaRegistrosArquivos
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cliente1.Nome = "João";
            cliente1.Idade = 30;
            cliente1.Email = "joao@exemplo.com";
            ...
            //Gravação de um segundo cliente
            Cliente cliente2;
            cliente2.Nome = "Maria";
            cliente2.Idade = 25;
            cliente2.Email = "maria@exemplo.com";
            ...
            clientes[0].Idade = 30;
            clientes[0].Email = "joao@exemplo.com";
            clientes[1].Nome = "Maria";
            clientes[1].Idade = 25;
            clientes[1].Email = "maria@exemplo.com";
            ...
            cliente3.Idade = 40;
            cliente3.Email = "carlos@exemplo.com";
            ...
            Console.WriteLine($"Informações de {cliente3.Nome} gravados em '{caminhoArquivo}'.");
            Console.WriteLine();
